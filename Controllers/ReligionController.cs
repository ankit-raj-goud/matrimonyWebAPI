...
namespace MatrimonyWebApi.Controllers
{
    ...
    public class ReligionController : Controller
    {
        ...
        public ReligionController(IReligionRepository repository)
        {
        ...
        [ActionName("Create")]
        [HttpPost]
        public IActionResult Create(ReligionMasterRequest request)
        {
            try
            {
        ...
        [ActionName("Update")]
        [HttpPut]
        public IActionResult Update(ReligionMasterRequest request)
        {
            try
            {
